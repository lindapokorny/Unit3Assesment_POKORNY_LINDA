...
public class LoginActivity extends AppCompatActivity {
    private static String SHAREDPREFSKEY = "org.pursuit.unit_03_assessment";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        intent.putExtra("Username", "Checkbox");
        startActivity(intent);

        SharedPreferences sharedPreferences = getSharedPreferences(SHAREDPREFSKEY, MODE_PRIVATE);
        sharedPreferences
                .edit()
                .putString("Username", "Checkbox")
                .apply();
